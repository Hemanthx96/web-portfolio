...
import { MouseArcade } from "@/components/MouseArcade";
    ...
    <main className="relative min-h-screen flex flex-col bg-black overflow-x-hidden">
      ...
      <section className="w-full max-w-7xl mx-auto py-24 px-6">
        ...
        <div className="mt-16">
          <motion.h3
            ...
            className="text-center text-2xl md:text-3xl font-semibold mb-4 text-white"
          >
            Playable <span className="text-gradient">Mouse Mini‑Game</span>
          </motion.h3>
          <motion.p
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center text-sm md:text-base text-gray-400 font-mono mb-6"
          >
            Move your mouse to steer the ship and collect the glowing orbs. Your
            score increases every time you grab one.
          </motion.p>
          <motion.div
                ...
                >
                  ...
                  >
                    ...
                    <motion.p
                      initial={{ opacity: 0.8 }}
                      animate={
                        isCardHovered ? { opacity: 1 } : { opacity: 0.8 }
                      }
                      transition={{ duration: 0.2 }}
      ...
      <section id="work" className="w-full max-w-7xl mx-auto py-24 px-6">
        ...
        <div className="space-y-16">
          {[
            { label: "Web Projects", badge: "Web Project", items: webProjects },
            {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`h-px flex-1 ${
                        label === "Web Projects"
                          ? "bg-gradient-to-r from-purple-500/40 to-transparent"
                          : "bg-gradient-to-r from-pink-500/40 to-transparent"
                      }`}
                    />
                  </div>
                    ...
                    {items.map((project, index) => {
                      ...
                      return (
                        <StarBorder
                          ...
                          as="div"
                          className="block"
                          color={label === "Web Projects" ? "cyan" : "magenta"}
                          speed="6s"
                        >
                          <Link
                      ...
                      >
                        {exp.skills.map((skill, skillIndex) => (
                          <motion.span
                            ...
                            whileHover={{ scale: 1.05, y: -3, rotate: -5 }}
                            whileTap={{ scale: 0.9 }}
          ...
          {[
            ...
            return (
              ...
              >
                <motion.div
                  variants={itemVariants}
                  whileHover={{ scale: 1.02, y: -10, rotateX: 5 }}
                  whileTap={{ scale: 0.98 }}
                  onMouseEnter={() => setIsCardHovered(true)}
                  onMouseLeave={() => setIsCardHovered(false)}
              ...
              return (
                ...
                >
                  <motion.a
                    ...
                    onMouseEnter={() => setIsCardHovered(true)}
                    onMouseLeave={() => setIsCardHovered(false)}
                    className="flex flex-col items-center gap-4 p-6 rounded-xl glass-card hover:glow-effect transition-all group"
